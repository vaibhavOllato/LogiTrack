  ...
  return (
    <header className="w-full bg-white shadow-md px-6 py-3 flex justify-between items-center">
      ...
      <div className="flex items-center gap-3">
        <FaUserCircle size={28} className="text-cyan-600" />
        <div>
      ...
      {/* Right: Logout Button */}
      <button className="flex items-center gap-2 bg-cyan-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-cyan-700 transition">
